...
public class Config {
    ...
    public void configure(Overrides overrides) {
    ...
    public static final class Overrides {
        ...
        public Overrides tintAlpha(float v) { tintAlpha = v; return this; }
        public Overrides tintColorRed(float v) { tintColorRed = v; return this; }
        public Overrides tintColorGreen(float v) { tintColorGreen = v; return this; }
        public Overrides tintColorBlue(float v) { tintColorBlue = v; return this; }

        public Overrides noFilter() {
            contrast(0f); whitePoint(0f); chromaMultiplier(1f);
            blurRadius(0f); refractionHeight(0f); refractionOffset(0f);
            return this;
        }

        public Overrides cornerRadius(float v) { cornerRadius = v; return this; }
        public Overrides refractionHeight(float v) { refractionHeight = v; return this; }
        public Overrides refractionOffset(float v) { refractionOffset = v; return this; }
        public Overrides contrast(float v) { contrast = v; return this; }
        public Overrides whitePoint(float v) { whitePoint = v; return this; }
        public Overrides chromaMultiplier(float v) { chromaMultiplier = v; return this; }
        public Overrides blurRadius(float v) { blurRadius = v; return this; }
        public Overrides dispersion(float v) { dispersion = v; return this; }
        public Overrides size(int w, int h) { width = w; height = h; return this; }
